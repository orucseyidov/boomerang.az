                        ...
                        <form action="<?=$class."/".$method ?>?id=<?=$id ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="value_en"><?=$values['value_en'] ?></textarea>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label>Kontent RU</label>
                                    <textarea class="form-control ckeditor" name="value_ru"><?=$values['value_ru'] ?></textarea>
                                </div>
