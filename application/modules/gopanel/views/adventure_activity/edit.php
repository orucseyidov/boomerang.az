                    ...
                    <div class="card-body">
                        <form action="<?=base_url("gopanel/{$class}/{$method}/?id={$id}") ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    <label>Alt yazi EN</label>
                                    <input type="text" name="text_en" class="form-control" value="<?=$values['text_en'] ?>" required>
                                </div>

                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    <label>Alt yazi RU</label>
                                    <input type="text" name="texte_ru" class="form-control" value="<?=$values['text_ru'] ?>" required>
                                </div>

                                
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    <label>Şəkil</label>
                                    <small class="pull-right imgnotfiy">Ölçü 235 x 50</small>
