...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                Qırmızı rəngdə yazılmaqını istədiyiniz yazını bu formada yazın 
                <code> &lt;span class="cvr-title-tp"&gt; Sizin Yazınız &lt;/span&gt; </code>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="/gopanel/<?=$class."/".$table ?>" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <input type="text" name="link" class="form-control" placeholder="Nümunə : <?=base_url() ?>" value="<?=$values['link'] ?>" required>
                                </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <small class="pull-right imgnotfiy">Ölçü 1920 x 1280</small>
