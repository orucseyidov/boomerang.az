                            ...
                            <tbody id="sortable" class="sortableIcon" data-table="<?=$table ?>">
                                ...
                                ?>
                                    <tr id="ord-<?=$value['id']?>">
                                        ...
                                        <td>
                                            <a target="_blank" href="<?= empty($value['image']) ? "/uploads/nophoto.png" : $value['image']; ?>">
                                                <img width="100" src="<?= empty($value['image']) ? "/uploads/nophoto.png" : $value['image']; ?>">
                                            </a>
                                        </td>
                                        <td><?=mb_substr(strip_tags($value['opinion']), 0,50) ?></td>
                                        <td>
                                            <div class="manage">
